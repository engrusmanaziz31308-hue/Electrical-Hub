...
function renderLoad(el){
      ...
      <div id="addLoadForm" style="margin-top:16px; padding-top:16px; border-top:1px solid var(--line-soft);">
        ...
        <div class="field-row" style="align-items:flex-end;">
          ...
          <div class="field" style="flex:1;">
            <div class="unit-suffix"><input type="number" id="newLoadWatt" min="0" value="100"><span>W</span></div>
          </div>
          <div class="field" style="flex:0 0 80px;">
            <input type="number" id="newLoadQty" min="0" value="1" title="${L('colQty')}">
          </div>
          <div class="field" style="flex:0 0 80px;">
            <input type="number" id="newLoadHrs" min="0" step="0.5" value="1" title="${L('colHours')}">
          </div>
  ...
  APPLIANCES.forEach(a=>{
    ...
    tr.innerHTML = `
      ...
      <td><input class="qty-input" style="width:74px;" type="number" min="0" value="${s.watt}" onchange="onLoadChange('${a.key}','watt',this.value)"></td>
      <td><input class="qty-input" type="number" min="0" value="${s.qty}" onchange="onLoadChange('${a.key}','qty',this.value)"></td>
      <td><input class="qty-input" type="number" min="0" step="0.5" value="${s.hrs}" onchange="onLoadChange('${a.key}','hrs',this.value)"></td>
...
function renderCustomLoadRows(){
  ...
  STATE.customLoads.forEach(c=>{
    ...
    tr.innerHTML = `
      ...
      <td><input class="qty-input" style="width:74px;" type="number" min="0" value="${c.watt}" onchange="onCustomLoadChange('${c.id}','watt',this.value)"></td>
      <td><input class="qty-input" type="number" min="0" value="${c.qty}" onchange="onCustomLoadChange('${c.id}','qty',this.value)"></td>
      <td><input class="qty-input" type="number" min="0" step="0.5" value="${c.hrs}" onchange="onCustomLoadChange('${c.id}','hrs',this.value)"></td>
    ...
    <div class="grid grid-2">
      <div class="card">
        ...
        <div class="field">
          ...
          <div class="unit-suffix"><input type="number" id="s_dailyEnergy" value="${s.dailyEnergy}" oninput="recalcSolar()"><span>Wh</span></div>
        </div>
        <div class="field">
          <label>${L('solarSafety')}</label>
          <div class="unit-suffix"><input type="number" id="s_safety" value="20" oninput="recalcSolar()"><span>%</span></div>
        </div>
        <div class="field" style="margin-bottom:0;">
          <label>${STATE.lang==='ur' ? 'مجموعی متصل لوڈ (پیک)' : 'Total connected / peak load'}</label>
          <div class="unit-suffix"><input type="number" id="s_peakLoad" value="${s.peakLoad}" oninput="recalcSolar()"><span>W</span></div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="field-row">
          <div class="field">
            ...
            <div class="unit-suffix"><input type="number" id="s_sunHours" value="5" step="0.1" oninput="recalcSolar()"><span>h</span></div>
          </div>
          <div class="field">
            <label>${L('solarSysEff')}</label>
            <div class="unit-suffix"><input type="number" id="s_sysEff" value="80" oninput="recalcSolar()"><span>%</span></div>
          </div>
        </div>
        <div class="field" style="margin-bottom:0;">
          <label>${L('solarPanelWp')}</label>
          <div class="unit-suffix"><input type="number" id="s_panelWp" value="330" oninput="recalcSolar()"><span>Wp</span></div>
        </div>
      ...
      <div class="card">
        ...
        <div class="field-row">
          <div class="field">
            ...
            <div class="unit-suffix"><input type="number" id="s_autonomy" value="1" step="0.5" oninput="recalcSolar()"><span>d</span></div>
          </div>
          <div class="field">
        ...
        <div class="field-row">
          <div class="field">
            ...
            <div class="unit-suffix"><input type="number" id="s_dod" value="50" oninput="recalcSolar()"><span>%</span></div>
          </div>
          <div class="field">
            <label>${L('solarBattEff')}</label>
            <div class="unit-suffix"><input type="number" id="s_battEff" value="85" oninput="recalcSolar()"><span>%</span></div>
          </div>
        </div>
        <div class="field" style="margin-bottom:0;">
          <label>${L('solarBattUnit')}</label>
          <div class="unit-suffix"><input type="number" id="s_battUnit" value="100" oninput="recalcSolar()"><span>Ah</span></div>
        </div>
        <div class="result-box" style="margin-top:14px;">
      ...
      <div class="card">
        ...
        <div class="field-row">
          <div class="field">
            ...
            <div class="unit-suffix"><input type="number" id="s_surge" value="1.25" step="0.05" oninput="recalcSolar()"><span>×</span></div>
          </div>
          <div class="field">
            <label>${L('solarPF')}</label>
            <div class="unit-suffix"><input type="number" id="s_pf" value="0.8" step="0.05" oninput="recalcSolar()"><span></span></div>
          </div>
        </div>
...
function renderOhm(el){
  el.innerHTML = `
    <div class="card" style="max-width:520px;">
      ...
      <div class="field"><label>${L('voltage')}</label><input type="number" id="ohmV" oninput="recalcOhm('V')"></div>
      <div class="field"><label>${L('current')}</label><input type="number" id="ohmI" oninput="recalcOhm('I')"></div>
      <div class="field"><label>${L('resistance')}</label><input type="number" id="ohmR" oninput="recalcOhm('R')"></div>
      <div class="result-box">
...
function renderPowerCalc(el){
  el.innerHTML = `
    <div class="card" style="max-width:520px;">
      ...
      <div class="field-row">
        <div class="field"><label>${L('voltage')}</label><input type="number" id="pw_v" value="230" oninput="recalcPower()"></div>
        <div class="field"><label>${L('current')}</label><input type="number" id="pw_i" value="5" oninput="recalcPower()"></div>
      </div>
      <div class="field"><label>${L('powerFactor')}</label><input type="number" id="pw_pf" value="0.9" step="0.05" oninput="recalcPower()"></div>
      <div class="result-box">
...
function renderEnergyCalc(el){
  el.innerHTML = `
    <div class="card" style="max-width:520px;">
      ...
      <div class="field-row">
        <div class="field"><label>${L('loadWatt')}</label><input type="number" id="en_w" value="1000" oninput="recalcEnergy()"></div>
        <div class="field"><label>${L('hoursPerDay')}</label><input type="number" id="en_h" value="5" oninput="recalcEnergy()"></div>
      </div>
      <div class="field-row">
        <div class="field"><label>${L('daysPerMonth')}</label><input type="number" id="en_d" value="30" oninput="recalcEnergy()"></div>
        <div class="field"><label>${L('ratePerUnit')}</label><input type="number" id="en_r" value="45" oninput="recalcEnergy()"></div>
      </div>
      <div class="result-box">
...
function renderP3Calc(el){
  el.innerHTML = `
    <div class="card" style="max-width:520px;">
      ...
      <div class="field-row">
        <div class="field"><label>${L('lineVoltage')}</label><input type="number" id="p3_v" value="400" oninput="recalcP3()"></div>
        <div class="field"><label>${L('lineCurrent')}</label><input type="number" id="p3_i" value="10" oninput="recalcP3()"></div>
      </div>
      <div class="field"><label>${L('powerFactor')}</label><input type="number" id="p3_pf" value="0.9" step="0.05" oninput="recalcP3()"></div>
      <div class="result-box">
...
function renderVdropCalc(el){
  el.innerHTML = `
    <div class="card" style="max-width:520px;">
      ...
      <div class="field-row">
        <div class="field"><label>${L('current')}</label><input type="number" id="vd_i" value="10" oninput="recalcVdrop()"></div>
        <div class="field"><label>${L('cableLength')}</label><input type="number" id="vd_len" value="20" oninput="recalcVdrop()"></div>
      </div>
      <div class="field"><label>${L('cableSize')}</label><input type="number" id="vd_size" value="2.5" step="0.5" oninput="recalcVdrop()"></div>
      <div class="field"><label>${L('voltage')}</label><input type="number" id="vd_v" value="230" oninput="recalcVdrop()"></div>
      <div class="result-box">
    ...
    el.innerHTML = `
      <div class="card" style="max-width:520px;">
        <div class="field">
          ...
          <input type="number" id="conv_value" value="1" oninput="recalcUnitConv()">
        </div>
        <div class="field-row">
          <div class="field">
